...
If you are using the `clang` compiler with Visual studio, check section link:https://github.com/modio/modio-sdk/blob/main/doc/getting-started.adoc#clang-win[Clang compiler in Visual Studio] for further details
