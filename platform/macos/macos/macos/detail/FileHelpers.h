...
namespace Modio
{
	...
	{
		/// @docinternal
		/// @brief Used to give context when translating mac error codes to differentiate shared codes
		...
		inline Modio::ErrorCode TranslateFilesystemError(int MacError, Modio::Detail::FilesystemErrorContext Context)
		{
			if (MacError == 0)
			{
				return {};
			...
			Modio::Detail::Logger().Log(Modio::LogLevel::Error, Modio::LogCategory::File,
										"Raw Mac filesystem error {} received", MacError);
