...
namespace Modio
{
	...
	{
		/// @docinternal
		/// @brief Used to give context when translating ios error codes to differentiate shared codes
		...
		inline Modio::ErrorCode TranslateFilesystemError(int IosError, Modio::Detail::FilesystemErrorContext Context)
		{
			if (IosError == 0)
			{
				return {};
			...
			Modio::Detail::Logger().Log(Modio::LogLevel::Error, Modio::LogCategory::File,
										"Raw iOS filesystem error {} received", IosError);
			switch (IosError)
			{
				case ENOENT:
