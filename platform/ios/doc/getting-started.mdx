...
slug: /ios/cpp-sdk/getting-started
sidebar_position: 0
---
...
In iOS, the default way to compile the mod.io SDK requires CMake, which you can install following the https://cmake.org/download/[CMake webpage] instructions or using a package manager like `brew`:
...
Check https://developer.apple.com/documentation/xcode/devices-and-simulator[Apple documentation] to retrieve those elements.
