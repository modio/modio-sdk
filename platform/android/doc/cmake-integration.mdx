...
5. Ensure that you have configured the environment variable `MODIO_NDK_ROOT` to point to your NDK installation directory.
...
6. There are some resources that must be copied from the mod.io SDK to your own Java application in order to compile and use the SDK. Make sure you include the following somewhere in your CMake scripts.
