...
You can set up your Android game so users can purchase creator credits through the Google Play Store, and the mod.io platform will verify those purchases and grant associated entitlements to the user. To enable this, first [follow these steps to configure entitlements for your game](https://docs.mod.io/platforms/google/marketplace). 
...
extern "C"
{
  JNIEXPORT void Java_com_modio_gui_1test_BillingHelper_nativeOnPurchaseSuccess(JNIEnv* env, jclass clazz, jstring jsonReceipt) 
  {
    ...
    EntitlementParams.ExtendedParameters.emplace("receipt", receipt);
