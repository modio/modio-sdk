...
typedef enum EModioLanguage
{
    ...
    EModioLanguage_SpanishLatinAmerican,
    EModioLanguage_Thai,
    EModioLanguage_ChineseSimplified,
    EModioLanguage_ChineseTraditional,
    EModioLanguage_Turkish,
    EModioLanguage_Ukrainian,
    EModioLanguage_Arabic,
    EModioLanguage_Czech,
    EModioLanguage_PortugueseBrazilian
} EModioLanguage; 
...
typedef enum EModioGameCommunityOption
{
    ...
    EModioGameCommunityOption_AllowModDependencies = 1024,
    EModioGameCommunityOption_AllowCommentsOnGuides = 2048
...
typedef enum EModioModCommunityOption
{
    EModioModCommunityOption_None = 0,
    EModioModCommunityOption_EnableComments = 1,
    EModioModCommunityOption_EnablePreviews = 64,
    EModioModCommunityOption_EnablePreviewURLs = 128,
    EModioModCommunityOption_AllowDependencies = 1024
} EModioModCommunityOption; 

typedef int32_t CModioModCommunityOptionsFlags;
inline bool ModioModCommunityOptionsFlagsHasFlag(CModioModCommunityOptionsFlags ValueToCheck, EModioModCommunityOption Flag)
{
    return (ValueToCheck & Flag) != 0;
}
inline CModioModCommunityOptionsFlags ModioModCommunityOptionsFlagsSetFlag(CModioModCommunityOptionsFlags Value, EModioModCommunityOption Flag)
{
    return Value | Flag;
}
inline CModioModCommunityOptionsFlags ModioModCommunityOptionsFlagsClearFlag(CModioModCommunityOptionsFlags Value, EModioModCommunityOption Flag)
{
    return Value & (~Flag);
}
inline CModioModCommunityOptionsFlags ModioModCommunityOptionsFlagsToggleFlag(CModioModCommunityOptionsFlags Value, EModioModCommunityOption Flag)
{
    return Value ^ Flag;
}

typedef struct COptionalModioModCommunityOptionsFlags
{
    CModioModCommunityOptionsFlags Value;
    bool HasValue;
} COptionalModioModCommunityOptionsFlags;
...
typedef struct CModioModCollectionStats CModioModCollectionStats;
...
typedef struct CModioModCollectionInfoList CModioModCollectionInfoList;
...
typedef struct CModioModCollectionID CModioModCollectionID;
...
typedef struct CModioEntitlementList CModioEntitlementList;
typedef struct CModioEntitlement CModioEntitlement;
...
MODIODLL_EXPORT void SetModioModCollectionStatsDownloadsToday(CModioModCollectionStats* Item, int64_t DownloadsToday);
MODIODLL_EXPORT void SetModioModCollectionStatsDownloadsTotal(CModioModCollectionStats* Item, int64_t DownloadsTotal);
MODIODLL_EXPORT void SetModioModCollectionStatsDownloadsUnique(CModioModCollectionStats* Item, int64_t DownloadsUnique);
MODIODLL_EXPORT void SetModioModCollectionStatsRatingTotal30Days(CModioModCollectionStats* Item, int64_t RatingTotal30Days);
MODIODLL_EXPORT void SetModioModCollectionStatsRatingPositive30Days(CModioModCollectionStats* Item, int64_t RatingPositive30Days);
MODIODLL_EXPORT void SetModioModCollectionStatsRatingNegative30Days(CModioModCollectionStats* Item, int64_t RatingNegative30Days);
MODIODLL_EXPORT void SetModioModCollectionStatsRatingTotal(CModioModCollectionStats* Item, int64_t RatingTotal);
MODIODLL_EXPORT void SetModioModCollectionStatsRatingPositive(CModioModCollectionStats* Item, int64_t RatingPositive);
MODIODLL_EXPORT void SetModioModCollectionStatsRatingNegative(CModioModCollectionStats* Item, int64_t RatingNegative);
MODIODLL_EXPORT void SetModioModCollectionStatsNumberOfComments(CModioModCollectionStats* Item, int64_t NumberOfComments);
MODIODLL_EXPORT void SetModioModCollectionStatsNumberOfMods(CModioModCollectionStats* Item, int64_t NumberOfMods);
...
MODIODLL_EXPORT void SetModioFileInfoFileSize(CModioFileInfo* Item, uint64_t FileSize);
MODIODLL_EXPORT void SetModioFileInfoFileSizeUncompressed(CModioFileInfo* Item, uint64_t FileSizeUncompressed);
...
MODIODLL_EXPORT void  SetModioModCollectionInfoListModCollectionInfoByIndex(CModioModCollectionInfoList* ModioModCollectionInfoList, uint64_t Index, CModioModCollectionInfo const* Value);
...
MODIODLL_EXPORT void SetModioModCollectionInfoId(CModioModCollectionInfo* Item, CModioModCollectionID const* Id);
MODIODLL_EXPORT void SetModioModCollectionInfoGameId(CModioModCollectionInfo* Item, CModioGameID const* GameId);
MODIODLL_EXPORT void SetModioModCollectionInfoServerStatus(CModioModCollectionInfo* Item, EModioModServerSideStatus ServerStatus);
MODIODLL_EXPORT void SetModioModCollectionInfoVisibility(CModioModCollectionInfo* Item, EModioObjectVisibility Visibility);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileSubmittedBy(CModioModCollectionInfo* Item, CModioUser const* ProfileSubmittedBy);
MODIODLL_EXPORT void SetModioModCollectionInfoCategory(CModioModCollectionInfo* Item, CModioString const* Category);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileDateAdded(CModioModCollectionInfo* Item, int64_t ProfileDateAdded);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileDateUpdated(CModioModCollectionInfo* Item, int64_t ProfileDateUpdated);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileDateLive(CModioModCollectionInfo* Item, int64_t ProfileDateLive);
MODIODLL_EXPORT void SetModioModCollectionInfoIncomplete(CModioModCollectionInfo* Item, bool Incomplete);
...
MODIODLL_EXPORT void SetModioModCollectionInfoFileSize(CModioModCollectionInfo* Item, uint64_t FileSize);
MODIODLL_EXPORT void SetModioModCollectionInfoFileSizeUncompressed(CModioModCollectionInfo* Item, uint64_t FileSizeUncompressed);
MODIODLL_EXPORT void SetModioModCollectionInfoPlatforms(CModioModCollectionInfo* Item, CModioPlatformList const* Platforms);
MODIODLL_EXPORT void SetModioModCollectionInfoTags(CModioModCollectionInfo* Item, CModioStringList const* Tags);
MODIODLL_EXPORT void SetModioModCollectionInfoStats(CModioModCollectionInfo* Item, CModioModCollectionStats const* Stats);
MODIODLL_EXPORT void SetModioModCollectionInfoLogo(CModioModCollectionInfo* Item, CModioModLogo const* Logo);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileName(CModioModCollectionInfo* Item, CModioString const* ProfileName);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileNameId(CModioModCollectionInfo* Item, CModioString const* ProfileNameId);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileSummary(CModioModCollectionInfo* Item, CModioString const* ProfileSummary);
MODIODLL_EXPORT void SetModioModCollectionInfoProfileDescription(CModioModCollectionInfo* Item, CModioString const* ProfileDescription);
...
MODIODLL_EXPORT void  SetModioEntitlementListAvailableEntitlementByIndex(CModioEntitlementList* ModioEntitlementList, uint64_t Index, CModioEntitlement const* Value);
...
typedef void (*ModioModCollectionListCallback)(CModioErrorCode*, CModioModCollectionInfoList*, void* ContextPtr);
typedef void (*ModioModCollectionInfoCallback)(CModioErrorCode*, CModioModCollectionInfo*, void* ContextPtr);
...
typedef void (*ModioAvailableUserEntitlementCallback)(CModioErrorCode*, CModioEntitlementList*);
