...
namespace Modio
{
	namespace Detail
	{
		inline void RefreshUserEntitlementsMetaAsync(Modio::EntitlementParams Params,
			std::function<void(Modio::ErrorCode, Modio::Optional<Modio::EntitlementConsumptionStatusList>)> Callback)
		{
			const Modio::Detail::HttpRequestParams RequestParams = Modio::Detail::SyncMetaEntitlementRequest
