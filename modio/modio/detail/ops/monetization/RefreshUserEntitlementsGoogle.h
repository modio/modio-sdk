...
namespace Modio
{
	namespace Detail
	{
		inline void RefreshUserEntitlementsGoogleAsync(Modio::EntitlementParams Params,
			std::function<void(Modio::ErrorCode, Modio::Optional<Modio::EntitlementConsumptionStatusList>)> Callback)
		{
			const Modio::Detail::HttpRequestParams RequestParams = Modio::Detail::SyncGoogleEntitlementsRequest
			.AppendPayloadValue(Modio::Detail::Constants::APIStrings::Receipt, Params.ExtendedParameters[Modio::Detail::Constants::APIStrings::Receipt]);
