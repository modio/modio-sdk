...
namespace Modio
{
	namespace Detail
	{
		inline void PurchaseModWithEntitlementMetaAsync(
			...
			std::function<void(Modio::ErrorCode, Modio::Optional<Modio::TransactionRecord>)> OnPurchaseComplete)
		{
			const Modio::Detail::HttpRequestParams RequestParams =
				Modio::Detail::PurchaseRequest
					.AppendPayloadValue("meta_device",
										Params.ExtendedParameters[Modio::Detail::Constants::APIStrings::Device])
					.AppendPayloadValue("meta_user_id",
										Params.ExtendedParameters[Modio::Detail::Constants::APIStrings::UserID])
