...
#include "modio/detail/HedleyWrapper.h"
	...
	#if HEDLEY_HAS_WARNING("-Wexplicit-specialization-storage-class")
		#define MODIO_DISABLE_WARNING_EXPLICIT_SPECIALIZATION_STORAGE_CLASS MODIO_DISABLE_WARNING(-Wexplicit-specialization-storage-class)
	#else
		#define MODIO_DISABLE_WARNING_EXPLICIT_SPECIALIZATION_STORAGE_CLASS
	#endif
	...
	#define MODIO_DISABLE_WARNING_HAS_NON_TRIVIAL_DTOR
	#define MODIO_DISABLE_WARNING_IMPLICIT_FALL_THROUGH
	#define MODIO_DISABLE_WARNING_IS_DEFINED_ZERO
	...
	#define MODIO_DISABLE_WARNING_UINT_TO_FLOAT_CONVERSION
	...
	#define MODIO_DISABLE_WARNING_UNUSED_CONST_VARIABLE
	...
	#if HEDLEY_HAS_WARNING("-Wunused-local-typedef")
		#define MODIO_DISABLE_WARNING_UNUSED_LOCAL_TYPEDEF MODIO_DISABLE_WARNING(-Wunused-local-typedef)
	#else
		#define MODIO_DISABLE_WARNING_UNUSED_LOCAL_TYPEDEF
	#endif
	...
	// Compiler Warning (level 3, off) C4265 : 'classname': class has virtual functions, but its non-trivial destructor is not virtual;
	#define MODIO_DISABLE_WARNING_HAS_NON_TRIVIAL_DTOR MODIO_DISABLE_WARNING(4265)
	...
	// Compiler Warning (level 0, off) C4574 : X is defined to be '0' : did you mean to use '#if X' ?
	#define MODIO_DISABLE_WARNING_IS_DEFINED_ZERO MODIO_DISABLE_WARNING(4574)
	...
	// Compiler Warning (level 4) C5219: implicit conversion from 'UINT' to 'FLOAT', possible loss of data
	#define MODIO_DISABLE_WARNING_UINT_TO_FLOAT_CONVERSION MODIO_DISABLE_WARNING(5219)
	...
	// Compiler warning (off) C5262: implicit fall-through occurs here; are you missing a break statement?
	#define MODIO_DISABLE_WARNING_IMPLICIT_FALL_THROUGH MODIO_DISABLE_WARNING(5262)

	// Compiler warning (off) C5264 'const' variable is not used
	#define MODIO_DISABLE_WARNING_UNUSED_CONST_VARIABLE MODIO_DISABLE_WARNING(5264)
