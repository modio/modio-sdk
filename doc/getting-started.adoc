...
However, you must be aware that Visual Studio 2019 & 2022 had some issues compiling projects with CMake & Ninja, like the following error:

```
The C compiler
  "C:/Program Files/Microsoft Visual Studio/2022/Community/VC/Tools/Llvm/x64/bin/clang-cpp.exe"
is not able to compile a simple test program.
```

To resolve this issue, you can add the following line to `CMakeList.txt` before the project definition
