:gitplant: http://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/modio/modio-sdk/doc/chapters/diagrams/general-overview/
...
These include the required CMake (version 3.15 or higher), Ninja, and MSVC C++ compiler.
