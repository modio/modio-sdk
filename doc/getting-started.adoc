...
|===
| Windows                    | Linux                    | OSX
|`${FolderID_Public}/mod.io` | `${USER_HOME}/mod.io`    | TBD
|===

NOTE: In Linux, mods and data binds to a single user. Every other client would have their own instance in their home directory.
