...
custom_edit_url: https://github.com/modio/modio-sdk-internal/blob/develop/doc/getting-started/cpp-authentication.mdx
---
...
Custom SSO & Platform Support is a premium feature. Please contact us at developers@mod.io for more information.
:::
...
1. Call [AuthenticateUserExternalAsync](https://docs.mod.io/cppsdk/refdocs#authenticateuserexternalasync) , passing in any provider-specific parameters, setting `AuthenticationParams::bUserHasAcceptedTerms` to false, and indicating which authentication provider you wish to use
2. Check the error code in the callback - if it indicates the user has not yet created an account or accepted the terms, call [GetTermsOfUseAsync](https://docs.mod.io/cppsdk/refdocs#gettermsofuseasync) and display the provided information to your user
...
Now that you've set up the authentication process, the next step is to allow users to find UGC by implementing the [Searching for UGC](https://docs.mod.io/cppsdk/searching-ugc) guide.
